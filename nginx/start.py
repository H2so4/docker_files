...
if not os.environ.get("SOCKET_PORT"):
	os.environ["SOCKET_PORT"] = "20523"

# Actual startup script
if not os.path.exists("/certs/dhparam.pem") and os.environ.get("TLS_FLAVOR") != "notls":
    os.system("openssl dhparam -out /certs/dhparam.pem 2048")

if os.environ.get("TLS_FLAVOR") == "letsencrypt":
    subprocess.Popen(["/letsencrypt.py"])
elif os.environ.get("TLS_FLAVOR") == "cert":
